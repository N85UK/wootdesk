...
| GO-009 | App Store Connect agreements and roles are ready | App record exists, API access is granted, and build 24 uploaded and processed. Final agreement and role review remains pending | In progress |
