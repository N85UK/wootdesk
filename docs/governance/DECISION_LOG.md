...
| DEC-007 | Use native APNs registration and a separate authenticated push provider instead of sending APNs tokens to Chatwoot's FCM endpoint | Client decision accepted, provider pending | `docs/decisions/0004-native-apns-and-push-provider-boundary.md` |
