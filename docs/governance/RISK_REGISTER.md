...
| RISK-014 | EU release is blocked while Digital Services Act trader verification keeps failing | 4 | 4 | 16 | Apple rejected the submission on 4 September 2026, case 20000152699489, because the address entered in App Store Connect does not match the supporting documentation. Resubmit under Business, legal entity, Agreements, Compliance, with the address transcribed exactly as it appears on the document supplied, including any unit or flat number, unabbreviated street type and the document's own postcode spacing. Only the account holder can do this. The trader address becomes public on the App Store listing by design, but it stays out of this public repository | Open, owner action |
